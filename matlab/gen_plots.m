...
for T = 0:9
    ...
    plot_lut(LUTV_W{T+1} - LUT1_W{T+1}, strcat('WHITE ', tr), strcat('plots/WHITE_T', int2str(T)));
    plot_lut(LUTV_W{T+1} - LUT2_W{T+1}, strcat('GREEN ', tr), strcat('plots/GREEN_T', int2str(T)));
    plot_lut(LUTV_W{T+1} - LUT3_W{T+1}, strcat('BLUE ', tr), strcat('plots/BLUE_T', int2str(T)));
